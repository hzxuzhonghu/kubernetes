...
func TestBatchWebhookMaxEvents(t *testing.T) {
	...
	got := make(chan int, 2)
	s := httptest.NewServer(pluginwebhook.NewFakeWebhookHandler(&auditv1beta1.EventList{}, func(events runtime.Object) {
...
func TestBatchWebhookRun(t *testing.T) {
	...
	s := httptest.NewServer(pluginwebhook.NewFakeWebhookHandler(&auditv1beta1.EventList{}, func(obj runtime.Object) {
